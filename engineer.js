...
(function(window) {
  ...
  if (typeof window.cloneMemoryBank === 'undefined') {
    window.cloneMemoryBank = {
      research: [], lyric: [], notes: [], language: [], word: [], letter: [], term: [], reminders: [], command: [], naming: [], collaborate: [], preference: [], lesson: [], tutor: [], illegal_registry: []
    };
  }
  ...
  if (typeof window.consoleEngineerAgency.initializeAgencyAjaxSession === 'function') {
